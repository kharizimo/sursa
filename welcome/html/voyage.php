        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <select name="compagnie" id="compagnie" class="form-control select2"><?=Combo::array(Vars::$aeroports,['no_data'=>['','Selectionnez compagnie']])?></select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="province_destination" id="province_destination" class="form-control"><?=Combo::array(Vars::$provinces_rdc,['no_data'=>['','Selectionnez province']])?></select>
                </div>
